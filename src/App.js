...
// function App() {
//   const inputStyle = {padding:'10px',borderRadius:'10px',width:'400px',marginLeft:'10px'}
//   let username="Max Miller"
...
//   return (
//     <div className='main'>
//      <h1 style={{color:'red',fontSize:'90px'}}>App Component - Root componentes
//      </h1>
//      <h2>Data</h2>
//      <label htmlFor="username">Username
//      </label>
//     <input style={inputStyle} type="text" id='username' placeholder={username} onChange={e=>updateUser(e.target.value)} value={username}/>
